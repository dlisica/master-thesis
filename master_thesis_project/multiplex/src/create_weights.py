...
### for multiple layers
def w_weighted_multiple(layers):
    w_layers = []
    for layer in layers:
        w_layers.append(w_weighted(layer))
    return w_layers

def w_uniform_multiple(layers):
    w_layers = []
    for layer in layers:
        w_layers.append(w_uniform(layer))
    return w_layers

def w_random_multiple(layers):
    w_layers = []
    for layer in layers:
        w_layers.append(w_random(layer))
    return w_layers

def w_trivalency_multiple(layers):
    w_layers = []
    for layer in layers:
        w_layers.append(w_trivalency(layer))
    return w_layers
